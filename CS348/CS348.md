...
SQL is a way to write relational algebra in a machine-readable format. SQL can be either interactive or embedded in an application, and embedded SQL is either static or dynamic. Interactive SQL is a subset of embedded, which is in turn a subset of relational algebra.
