...
What is a data item? In our models they are the smallest unit that we can lock. In real DBMSs, there are different levels of locking - we can lock tables, columns, and even individual rows.