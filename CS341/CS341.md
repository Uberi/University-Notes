...
def depth_first_search(vertices, adjacency_list):
    ...
    for vertex in vertices:
        if colors[vertex] == "white":
            visit(vertices, adjacency_list, vertex, colors, predecessors, current_time, discovery_time, finish_time)

def visit(vertices, adjacency_list, vertex, colors, predecessors, current_time, discovery_time, finish_time):
    colors[vertex] = "gray"
    current_time[0] += 1
    ...
    for neighbor in adjacency_list[vertex]:
        if colors[neighbor] = "white":
            predecessors[neighbor] = vertex
            visit(vertices, adjacency_list, neighbor, colors, predecessors, current_time, discovery_time, finish_time)
    colors[vertex] = "black"
    current_time[0] += 1
...
def spanning_tree(vertices, edges, weight_function):
    ...
    while len(tree_edges) < len(vertices) - 1:
        ...
        for vertex in vertices - tree_vertices: #
