...
If no constructor is specified in a class, then there is a default constructor that calls the default constructor for each of the fields, if they exist. Most of the time, this doesn't do anything.
...
And the following would go in the source file:
    ...
    In the scope of the class that comes before this scope resolution operator, somebody has implemented a function/method with the name Node
