...
For example, USB is a serial protocol with two data lines, both used in differential signalling. Normal signalling has a data line's voltage go up and down relative to a reference voltage to represent 0 and 1. Differential signalling has two data lines, and their relative voltages go up and down to represent 0 and 1 - this allows us to achieve significantly better practical speeds.
