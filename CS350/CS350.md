...
**Note:** I made a Docker image containing a full [development environment](https://github.com/Uberi/uw-cs350-development-environment#readme), current as of Spring 2016. This is basically all of the tools you need to complete the CS350 coursework, in a format that will work without any fuss. Notably, this image fixes several issues with setting up compiler versions and ncurses incompatibilities.
