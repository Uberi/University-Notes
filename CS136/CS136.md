...
Whenever possible, we should assert the preconditions of functions.
...
In C, `printf` actually produces the number of characters printed.
...
The values of expression statements are simply ignored, like those in Racket's `begin`.