...
DSA has the public domain parameters $p, q, g$ and uses the SHA256 hash.
...
Compared to RSA, DSA signatures are pretty short, a big practical reason people use it over RSA.