...
* Normal science - scientific activity that is guided by the paradigm.
  * This is how science works most of the time - there are textbooks, standard practices, etc.
...
Kuhn critisizes Popperian falsificationism by saying that in practice it would not work, since people would waste all their time trying to falsify the foundations of everything. To make progress, he says, researchers need to be on the same page.