...
There is a reason we can't tranfer our research over from the old paradigm to the new. The paradigm itself defines what a legitimate scientific question or answer is. In other words, a paradigm shift changes the questions in addition to the answers. For example, "what is the size of the epicycle of the moon?" is a legitimate question in Ptolomian astronomy, but doesn't make any sense in Copernican astronomy.
