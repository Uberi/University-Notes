...
**Mutual recursion** is recursion involving two or more functions that call each other recursively. Care must be taken to ensure that the base case is eventually reached.
